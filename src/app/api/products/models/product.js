...
export const createProductModel = async ({ name, category, quantity, image, size, price, aditionals, description }) => {
  try {
    ...
    const newProduct = product({ name, category, quantity, image, size, price, aditionals, description })
